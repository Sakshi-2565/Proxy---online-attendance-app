...
def student_dashboard():
    ...
    with col2:
        ...
        if st.button("Logout",type='primary',width='content',key='loginbackbtn',shortcut="control+backspace"):
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button():
            if st.button("Unenroll from this course",type='tertiary',key=f"""unenrollto{sub_id}btn""",icon=":material/delete_forever:",width='stretch'):
...
def student_screen():
    ...
    if photo_source:
        ...
        with st.spinner('AI is scanning..'):
            detected, all_ids, num_faces = predicted_attendance(img)
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input('Enter your name',placeholder='E.g. Sakshi Vishwakarma')
