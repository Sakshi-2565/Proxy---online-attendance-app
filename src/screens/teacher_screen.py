...
from src.components.add_photos_dialogue import add_photos_dialog
from src.components.dialog_attendance_results import attendance_Result_dialog
from src.pipelines.face_pipeline import predicted_attendance
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning('You havent created any subjects yet! Please create to begin!')
        return
    ...
    with col1:
        selected_subjects_labels = st.selectbox('Select Subject',options = list(subject_options.keys()))

    with col2:
        if st.button("Add Photos",type='primary',icon=':material/photo_prints:',width='stretch'):
            add_photos_dialog()

    selected_subject_id = subject_options[selected_subjects_labels]
        ...
        if st.button('Run Face Analysis',width='stretch',type='secondary',icon=':material/analytics:',disabled=not has_photos):
            with st.spinner('Deep scanning classroom photos...'):
                ...
                for idx, img in enumerate(st.session_state.attendance_images):
                    ...
                    detected,_,_= predicted_attendance(img_np)
...
def teacher_tab_manage_subject():
    ...
    if subjects:
        ...
        st.info("NO SUBJECTS FOUND, CREATE ABOVE")
...
def teacher_tab_attendance_records():
    ...
    summary =(
        df.groupby(['its_group','Time','Subject','Subject Code'])
        .agg(
    ...
    displayed_df = (summary.sort_values(by='its_group',ascending = False)
...
def register_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm):
    ...
    try:
        ...
        return True,"Sucessfullly Created! Login Now"
...
def teacher_screen_register():
    ...
    teacher_pass_confirm=st.text_input("Enter confirm password",placeholder="Enter confirm password",type='password')
